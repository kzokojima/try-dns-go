...
var rootServers = []dns.ResourceRecord{
	{Name: "a.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("198.41.0.4"))},
	...
	{Name: "b.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("199.9.14.201"))},
	...
	{Name: "c.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("192.33.4.12"))},
	{Name: "c.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:500:2::c"))},
	{Name: "d.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("199.7.91.13"))},
	{Name: "d.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:500:2d::d"))},
	{Name: "e.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("192.203.230.10"))},
	{Name: "e.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:500:a8::e"))},
	{Name: "f.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("192.5.5.241"))},
	{Name: "f.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:500:2f::f"))},
	{Name: "g.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("192.112.36.4"))},
	...
	{Name: "h.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("198.97.190.53"))},
	{Name: "h.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:500:1::53"))},
	{Name: "i.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("192.36.148.17"))},
	{Name: "i.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:7fe::53"))},
	{Name: "j.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("192.58.128.30"))},
	...
	{Name: "k.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("193.0.14.129"))},
	{Name: "k.root-servers.net.", Type: dns.TypeAAAA, Class: dns.ClassIN, TTL: 3600000, RData: dns.AAAA(netip.MustParseAddr("2001:7fd::1"))},
	{Name: "l.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("199.7.83.42"))},
	...
	{Name: "m.root-servers.net.", Type: dns.TypeA, Class: dns.ClassIN, TTL: 3600000, RData: dns.A(netip.MustParseAddr("202.12.27.33"))},
